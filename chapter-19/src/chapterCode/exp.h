...
public:
     ...
     * constructor will define itw own constructor/
     */
    Expression();
...
public:
    ...
    /* Prototyes for the virtual methods overridden by this class */
 ...
 * two subexpression joined by an operator.
 */
...
public:
    ...
    /* Prototype for the virtual methods overridden by this class */
...
public:
     ...
     * Return true if the specified variable is defined.
     */
