...
void EditorBuffer::moveCursorForward() {
    if(cursorPosition != count) {
        while(cursorPosition != count && isspace(array[cursorPosition])) cursorPosition++;
        while(cursorPosition != count && !isspace(array[cursorPosition])) {
            cursorPosition++;
        }
    }
}
...
void EditorBuffer::moveCursorBackward() {
    if(cursorPosition != 0) {
        while(cursorPosition-1 != 0 && isspace(array[cursorPosition-1])) cursorPosition--;
        while(cursorPosition-1 != 0 && !isspace(array[cursorPosition-1])) {
            cursorPosition--;
        }
    }
}
